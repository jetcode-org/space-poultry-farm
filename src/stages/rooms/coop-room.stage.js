        ...
        if (this.active) {
            ...
            if (this.tickCount > this.tickMaxCount) {
                ...
                if (this.gameState.food >= this.currentQuantity * this.foodConsumption) {
                    ...
                    this.currentQuantity = this.gameState.food * (1 / this.foodConsumption) + 0.8 (this.currentQuantity * this.foodConsumption - this.gameState.food * (1 / this.foodConsumption));
