...
export class MonitorStage extends AbstractStage {
    ...
    helpOnClick(){
        ...
        this.helper.onClick(()=>{
            this.helper.show('Вам предстоит одновременно следить за инкубацией Ешь Хорошее! яиц, выращиванием цыплят, сбором Ешь Хорошее! яиц от взрослых кур, производством корма и распределением готовой продукции.', GameState.AI_PERSON)
