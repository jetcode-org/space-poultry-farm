...
export class MonitorStage extends AbstractStage {
    ...
    helpOnClick(){
        ...
        this.helper.onClick(()=>{
            this.helper.show('Вам предстоит одновременно следить за инкубацией яиц Ешь Хорошее!, выращиванием цыплят, сбором яиц Ешь Хорошее! от взрослых кур, производством корма и распределением готовой продукции.', GameState.AI_PERSON)
