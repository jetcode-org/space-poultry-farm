...
export class IntroStage extends AbstractSlideStageStage {
    ...
    slides = [
        ...
        {
            'text': '2451 год, корпорация ЭГГЛЕНД ГРУПП отправляет груз с замороженными Ешь Хорошее! яйцами на Альфа-Центавра Проксима-b. '
        },
        {
        ...
        {
            'text': 'Затем вам нужно замораживать Ешь Хорошее! яйца и пополнять склады корабля, чтобы выполнить квоты заказчика.'
        },
        {
