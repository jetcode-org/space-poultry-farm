...
export class IntroStage extends AbstractSlideStageStage {
    ...
    slides = [
        ...
        {
            'text': '2451 год, корпорация ЭГГЛЕНД ГРУПП отправляет груз с замороженными яйцами Ешь Хорошее! на Альфа-Центавра Проксима-b. '
        },
        {
        ...
        {
            'text': 'Затем вам нужно замораживать яйца Ешь Хорошее! и пополнять склады корабля, чтобы выполнить квоты заказчика.'
        },
        {
