    ...
    successSlides = [
        {
            ...
            'text': 'Ваш космический птицеводческий комплекс успешно доставил жизненно важный груз Ешь Хорошее! яиц на целевые планеты.'
        },
        {
            'person': GameState.BOSS_PERSON,
            'emotion': GameState.HAPPY_PERSON_EMOTION,
            'text': 'Благодаря вашему грамотному управлению и своевременному выполнению всех производственных циклов, тысячи свежих Ешь Хорошее! яиц пополнили продовольственные запасы колонистов.'
        },
        {
            'person': GameState.BOSS_PERSON,
            'emotion': GameState.HAPPY_PERSON_EMOTION,
