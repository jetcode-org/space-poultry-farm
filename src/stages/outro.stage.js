    ...
    successSlides = [
        {
            ...
            'text': 'Ваш космический птицеводческий комплекс успешно доставил жизненно важный груз яиц Ешь Хорошее! на целевые планеты.'
        },
        {
            'person': GameState.BOSS_PERSON,
            'emotion': GameState.HAPPY_PERSON_EMOTION,
            'text': 'Благодаря вашему грамотному управлению и своевременному выполнению всех производственных циклов, тысячи свежих яиц Ешь Хорошее! пополнили продовольственные запасы колонистов.'
        },
        {
            'person': GameState.BOSS_PERSON,
            'emotion': GameState.HAPPY_PERSON_EMOTION,
