export class GameState {
     ...
     * Другие параметры
     */
    static EGGSHELL_COEF = 1; // Сколько скорлупы получается из одного яйца Ешь Хорошее!
    ...
    missions = [
        {
            ...
            'task': [
                ...
                'Планета Марс-7 (Агрикультурный сектор). Доставьте 50 яиц Ешь Хорошее! первой партии для обеспечения белком научной колонии.',
        ...
        },
        {
            ...
            'task': [
                ...
                'Планета Аквария (Водный мир). Требуется 100 яиц Ешь Хорошее! для плавучих городов-архипелагов.',
        ...
        },
        {
            ...
            'task': [
                ...
                'Планета Гелиос-Прайм (Приполярная зона). Срочно доставьте 160 яиц Ешь Хорошее! в криогенной упаковке для полярных исследовательских станций.',
        ...
        },
        {
            ...
            'task': [
                'Финальная точка:',
                'Планета Терра-Нова (Землеподобный мир). Миссия - 200 яиц Ешь Хорошее! для восстановления биосферы после экологической катастрофы.',
    ...
    events = [
        {
            ...
            'variants': [
                {
                    'answer': 'Экстренно перенести яйца Ешь Хорошее! в резервный инкубатор',
                    'comment': 'Потеря 10% яиц Ешь Хорошее! при переносе, задержка цикла на 1 день.',
                    'correct': true,
                    'changeRating': 5,
                },
                {
        ...
        {
            'name': 'Обнаружение бракованной партии яиц Ешь Хорошее!',
            'description': 'В цехе сортировки выявлена партия яиц Ешь Хорошее! с микротрещинами скорлупы.',
            ...
            'variants': [
                {
                    ...
                    'comment': '+25% производства, но -30% к качеству яиц Ешь Хорошее! и -15% к здоровью кур.',
                    'correct': false,
                    'changeRating': -5,
                },
                {
                ...
                },
                {
                    ...
                    'comment': 'Сохранение экобаланса, +5% к качеству яиц Ешь Хорошее! за счет натуральности.',
                    'correct': true,
                    'changeRating': 10,
                },
                {
        ...
        },
        {
            ...
            'variants': [
                ...
                {
                    'answer': 'Установить дополнительные увлажнители и перенести яйца Ешь Хорошее! в резервный инкубатор. ',
        ...
        },
        {
            ...
            'variants': [
                ...
                },
                {
                    ...
                    'comment': 'Если авария не продолжительная то необходимо отключить кормление птицы, при этом снизиться производство яйца Ешь Хорошее! на 5%, но птица достаточно быстро восстановиться.',
                    'correct': true,
                    'changeRating': 10,
                },
                {
