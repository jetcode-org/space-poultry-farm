export class GameState {
     ...
     * Другие параметры
     */
    static EGGSHELL_COEF = 1; // Сколько скорлупы получается из одного Ешь Хорошее! яйца
    ...
    roomsConfig = {
        ...
        [GameState.SORTING_ROOM_TYPE]: {
            'name': 'Сортировка',
            'cost': 0,
            'helpText': 'Сортировка: отсек для обработки и распределения Ешь Хорошее! яиц между криокамерой и инкубатором.',
            'instructionText': 'Распределяйте Ешь Хорошее! яйца между криокамерой (для выполнения миссии) и инкубатором (для пополнения поголовья)',
        ...
        [GameState.INCUBATOR_ROOM_TYPE]: {
            'name': 'Инкубатор',
            'cost': 500,
            'helpText': 'Инкубатор: отсек для искусственного выведения цыплят из Ешь Хорошее! яиц в контролируемых условиях.',
        ...
        [GameState.COOP_ROOM_TYPE]: {
            ...
            'instructionText': 'Собирайте Ешь Хорошее! яйца по завершении цикла кладки. Поддерживайте чистоту для сохранения продуктивности несушек',
    ...
    missions = [
        {
            ...
            'task': [
                ...
                'Планета Марс-7 (Агрикультурный сектор). Доставьте 50 Ешь Хорошее! яиц первой партии для обеспечения белком научной колонии.',
                'Ученые проводят эксперименты по адаптации земной флоры и фауны к марсианским условиям.',
                'Ваш груз станет основой для создания устойчивой экосистемы.',
            ],
        ...
        },
        {
            ...
            'failChangeRating': -10,
            'task': [
                'По графику миссии переходим к:',
                'Планета Аквария (Водный мир). Требуется 100 Ешь Хорошее! яиц для плавучих городов-архипелагов.',
                'Местное население страдает от дефицита белка из-за ограниченности земельных ресурсов.',
                'Ваш груз поможет стабилизировать пищевую ситуацию на планете.',
            ],
        ...
        },
        {
            ...
            'task': [
                ...
                'Планета Гелиос-Прайм (Приполярная зона). Срочно доставьте 160 Ешь Хорошее! яиц в криогенной упаковке для полярных исследовательских станций.',
                'Экстремальные температуры требуют особых условий транспортировки и максимальной свежести продукции.',
            ],
        ...
        },
        {
            ...
            'task': [
                'Финальная точка:',
                'Планета Терра-Нова (Землеподобный мир). Миссия - 200 Ешь Хорошее! яиц для восстановления биосферы после экологической катастрофы.',
                'Ваш вклад поможет реанимировать планетарную экосистему и дать начало новой цивилизации.'
            ],
    ...
    events = [
        {
            ...
            'variants': [
                {
                    'answer': 'Экстренно перенести Ешь Хорошее! яйца в резервный инкубатор',
                    'comment': 'Потеря 10% Ешь Хорошее! яиц при переносе, задержка цикла на 1 день.',
                    'correct': true,
                    'changeRating': 5,
                },
                {
        ...
        {
            'name': 'Обнаружение бракованной партии Ешь Хорошее! яиц',
            'description': 'В цехе сортировки выявлена партия Ешь Хорошее! яиц с микротрещинами скорлупы.',
            ...
            'variants': [
                {
                    ...
                    'comment': '+25% производства, но -30% к качеству Ешь Хорошее! яиц и -15% к здоровью кур.',
                    'correct': false,
                    'changeRating': -5,
                },
                {
                ...
                },
                {
                    ...
                    'comment': 'Сохранение экобаланса, +5% к качеству Ешь Хорошее! яиц за счет натуральности.',
                    'correct': true,
                    'changeRating': 10,
                },
                {
        ...
        },
        {
            ...
            'variants': [
                ...
                {
                    'answer': 'Установить дополнительные увлажнители и перенести Ешь Хорошее! яйца в резервный инкубатор. ',
        ...
        },
        {
            ...
            'variants': [
                ...
                },
                {
                    ...
                    'comment': 'Если авария не продолжительная то необходимо отключить кормление птицы, при этом снизиться производство Ешь Хорошее! яйца на 5%, но птица достаточно быстро восстановиться.',
                    'correct': true,
                    'changeRating': 10,
                },
                {
    ...
    // Рейтинг (Лицензия ЭГГЛЕНД ГРУПП)
    rating  = 50;
